...
insert into course_registration( Registered_ID,Level,Semester,Student_ID)
values('Reg_001',2,2,'Stu_001');

insert into course_registration( Registered_ID,Level,Semester,Student_ID)
values('Reg_002',2,2,'Stu_002');

insert into course_registration( Registered_ID,Level,Semester,Student_ID)
values('Reg_003',2,2,'Stu_003');

insert into course_registration( Registered_ID,Level,Semester,Student_ID)
values('Reg_004',2,2,'Stu_004');

insert into course_registration( Registered_ID,Level,Semester,Student_ID)
values('Reg_005',2,2,'Stu_005');
